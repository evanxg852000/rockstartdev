...
pub enum Instruction {
    ...
    Jump(Address),
    Call(Address),
    SkipIfEqualByte(Register, u8),
    SkipIfNotEqualByte(Register, u8),
...
impl RawInstruction {
   ...
   pub fn to_instruction(&self) -> Option<Instruction> {
        match self.xooo() {
            ...
            0x3 => Some(Instruction::SkipIfEqualByte(self.oxoo(),self.ooxx())),
            0x4 => Some(Instruction::SkipIfNotEqualByte(self.oxoo(), self.ooxx())),
